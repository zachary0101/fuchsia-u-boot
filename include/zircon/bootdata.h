...
#ifndef _ZIRCON_BOOTDATA_H_
#define _ZIRCON_BOOTDATA_H_
...
#define BOOTDATA_TYPE_METADATA   (0x0000006D)
#define BOOTDATA_TYPE_METADATA_MASK (0x000000FF)
